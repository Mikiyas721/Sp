...
class _$LoginStateCopyWithImpl<$Res> implements $LoginStateCopyWith<$Res> {
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      admin: admin == freezed ? _value.admin : admin as Option<Admin>,
      hasSubmitted:
...
class _$_LoginState implements _LoginState {
  ...
  @override
  String toString() {
    return 'LoginState(phoneNumber: $phoneNumber, password: $password, requestFailure: $requestFailure, admin: $admin, hasSubmitted: $hasSubmitted, hasRequested: $hasRequested)';
  }
