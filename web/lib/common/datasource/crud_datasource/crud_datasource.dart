...
abstract class CrudReadOnlyDataSource<T extends Dto, F extends Failure> {
...
abstract class CrudDataSource<T extends Dto, F extends Failure> extends CrudReadOnlyDataSource<T, F> {
